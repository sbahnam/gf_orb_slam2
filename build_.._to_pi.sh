...
cmake -DCMAKE_TOOLCHAIN_FILE=/home/stavrow/Git/pi0ORBSLAM2/Toolchain-rpi.cmake -DCMAKE_BUILD_TYPE=Release -DENABLE_CUDA_IN_OPENCV=False -DORB_LIB_TYPE:STRING="STATIC" $DIR 
